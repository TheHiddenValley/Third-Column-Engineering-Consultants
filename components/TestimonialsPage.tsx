...
const testimonials = [
  ...
  },
  {
    ...
    company: "Kilua Homes",
    quote:
      "As the Director of Kilua Homes, we have worked closely with Laava Events and Facility Consulting, Singapore, on our residential project, Kilua Homes, Mombasa, Kenya. I view them as very professional, creative and thoughtful architectural firm. They possess the relevant skills of listening, understanding and valuing our views as client and come up with solutions that are culturally, technically and economically relevant. We have been fully satisfied with their work and I do recommend them without any hesitation to anyone who is looking for their service.",
  },
];
...
const TestimonialsPage = () => {
  ...
  return (
    <section
      id="testimonials"
      className="p-6 md:h-screen h-auto flex flex-col items-center justify-center bg-orange-600"
    >
      <div className="flex items-center mb-4 relative md:flex-row">
        ...
        <div className="max-w-[95vw] text-3xl font-serif p-6 text-white rounded-lg">
          ...
          <p className="text-xl text-right font-thin mt-2">
            -{currentTestimonial.name}
          </p>
          <p className="text-lg text-right font-thin mt-2">
