...
const Portfolio = () => {
  ...
  return (
    <section id='portfolio' className='bg-slate-100  p-5'>
      ...
      <div className="grid grid-cols-3 gap-4">
        {filteredProjects.map((project, index) => (
          <div key={index} className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-60 text-white opacity-0 hover:opacity-100 transition-opacity">
